...
public class DebugLogUi
{
    ...
    public void Draw()
    {
        ...
        ImGui.TextWrapped("Every emote or action you use shows up here with its exact ID and name - use " +
                           "it to confirm detection is actually firing, and to double-check which trigger " +
                           "a mapping matched. This only covers your own local-player emotes/actions (the " +
                           "native-detected ones that actually carry a numeric ID); other players' emotes " +
                           "aren't listed here.");
